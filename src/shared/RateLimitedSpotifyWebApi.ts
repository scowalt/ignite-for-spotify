...
import { Paging, Playlist, PrivateUser, Track } from "spotify-web-api-ts/types/types/SpotifyObjects";
...
export class RateLimitedSpotifyWebApi {
	...
	public searchTracks(searchQuery: Query): Promise<Paging<Track> | undefined> {
	...
	public updateAccessToken(): Promise<void> {
		return this.spotify.getRefreshedAccessToken(this.refreshToken).then((value: GetRefreshedAccessTokenResponse) => {
